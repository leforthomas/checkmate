var linkedinapi = {
    ...
    userInfo: function(options) {
        options.format = 'json';
        return $.getJSON('https://api.linkedin.com/v1/people/~', options);
    },
    connections: function(options) {
        options.format = 'json';
        return $.getJSON('https://api.linkedin.com/v1/people/~/connections:(formatted-name,picture-url,public-profile-url)', options);
    },
    share: function(options) {
        options.format = 'json';
        return $.post('https://api.linkedin.com/v1/people/~/shares', options);
    }
};
